...
namespace AutomotrizApp.Datos
{
    public class HelperDao
    {
        ...
        private HelperDao()
        {
            cnn = new SqlConnection(@"Data Source=LAPTOP-CF2SCS3E\MSSQLSERVER02;Initial Catalog=Automotriz;Integrated Security=True");
        }
        ...
        public bool Login(string sp, Usuario user)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = cnn;
                cmd.Parameters.Add("@nom_usuario", SqlDbType.VarChar).Value = user.Nombre;
